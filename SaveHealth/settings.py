"""
Django settings for SaveHealth project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users_app.context_processors.user_groups',
            ],
        },
    },
]

WSGI_APPLICATION = 'SaveHealth.wsgi.application'
